...
/*
 * Defines added from Unix Makefile for Win32 version
 */
#define PERL_EXE_PATH "C:\\activestate\\perl\\bin\\perl"
#define MIME_TYPE "application/x-perlplus:.ppl:Perl"
#define CGI_TYPE "content-type: application/x-secure-cgi\nContent-length:"
#define SECURE_CGI "http://your.www-server.name.here/cgi-bin/perlplus-secure.cgi"
#define VERSION	"0.95"
#define PERL5005 1
//#define NPP_DEBUG 1
/*
